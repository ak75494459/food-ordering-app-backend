...
export const validateMyRestaurantRequest = [
  ...
  body("menuItems.*.name").notEmpty().withMessage("Menu item name is requied"),
  body("menuItems.*.price").isFloat({min:0}).withMessage("Menu item price is requied and must be a positive number"),
  handleValidationErrors,
];
